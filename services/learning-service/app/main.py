...
from app.api.internal_ai_context import router as internal_ai_context_router
from app.api.internal_course_access import router as internal_course_access_router
...
from app.api.material_access import router as material_access_router
...
app.include_router(internal_ai_context_router)
app.include_router(internal_course_access_router)
app.include_router(internal_quiz_generation_router)
app.include_router(internal_profile_update_router)
app.include_router(material_access_router)
